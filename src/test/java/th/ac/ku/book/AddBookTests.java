...
//        WebElement submitButton = driver.findElement(By.id("submitButton"));
        ...
        WebElement name = wait.until(webDriver ->
                webDriver.findElement(By.xpath("//table/tbody/tr[1]/td[1]")));
        WebElement author = wait.until(webDriver ->
                webDriver.findElement(By.xpath("//table/tbody/tr[1]/td[2]")));
        WebElement price = wait.until(webDriver ->
                webDriver.findElement(By.xpath("//table/tbody/tr[1]/td[3]")));
